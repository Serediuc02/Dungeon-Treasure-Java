...
import com.andrei.game.states.GameStatesManager;
...
public class Button
{
   ...
   // private ArrayList<SlotEvent> slotevents;
    ...
    public Button(String label, BufferedImage image, Font font, Vector2f pos, int buttonWidth, int buttonHeight) {
        GameStatesManager.g.setFont(font);
        FontMetrics met = GameStatesManager.g.getFontMetrics(font);
...
//            g.drawRect((int) bounds.getPos().x,(int) bounds.getPos().y,hoverImage.getWidth(),hoverImage.getHeight());
